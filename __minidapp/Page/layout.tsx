    ...
    <>
      ...
      <main id="nd-docs-layout" className="flex flex-1 flex-row">
            ...
            <div className="relative w-full mt-2">
              ...
              >
                ...
                <div className="flex-1 text-left">
                  <p className="text-sm font-medium">{activeSubMenu?.title}</p>
              ...
              >
                ...
                >
                  {SECTION_MENU.map((menuItem) => (
                    <Link
                      key={menuItem.href}
                      className="flex w-full flex-row gap-2 p-2 hover:bg-fd-accent/50"
                      onClick={() => setSectionMenuOpen(false)}
                      to={menuItem.href}
                    >
                      {menuItem.icon}
              ...
              <div>
                ...
                <div className="px-4 py-6 md:px-3">
                  <div className="flex flex-col gap-8">
                    {activeMenu &&
                      activeMenu.map((nav) => (
                        <div key={nav.title} className={nav.parentClass ?? ""}>
                          {!nav.skip && (
        ...
        <div className="mx-auto flex min-w-0 max-w-[860px] flex-1 flex-col">
          {/* Mobile nav */}
          <div className="hidden sticky top-14 z-10 border-b bg-fd-background/60 text-sm backdrop-blur-md md:top-1 md:mx-3 md:rounded-full md:border md:shadow-md lg:hidden">
            <button
              type="button"
              aria-haspopup="dialog"
              aria-expanded="false"
          ...
          <article className="flex flex-1 flex-col gap-6 px-4 pt-10 md:px-6 md:pt-12">
            <div className="prose mb-16">{children}</div>
          </article>
        </div>

        {/* On-this-page */}
        <div className="hidden sticky top-0 flex h-dvh w-[var(--fd-c-toc)] min-w-[var(--fd-toc-width)] flex-col gap-4 pe-[max(calc(var(--fd-c-toc)-var(--fd-toc-width)),0.75rem)] pt-12 max-lg:hidden">
            ...
            >
              <div>
                ...
                <div className="flex flex-col">
                  ...
                  >
                    <div className="absolute inset-y-0 w-px bg-fd-foreground/10"></div>
                    What is Minima?
                  </a>
                  <a
                    data-active="false"
                    href="#who-is-minima-for"
                    className="relative py-2 transition-colors [overflow-wrap:anywhere] first:pt-0 last:pb-0 data-[active=true]:text-fd-primary"
                  >
                    <div className="absolute inset-y-0 w-px bg-fd-foreground/10"></div>
                    Who is Minima for?
          ...
          <a
            href="https://github.com/minima-global/docs/blob/main/content/docs/core/index.mdx"
            target="_blank"
            rel="noreferrer noopener"
