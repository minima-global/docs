...
```bash title="Terminal"
megammrsync action:resync host:megammr.minima.global:9001 file:myoldbackup.bak password:backup_password
```

```bash title="Terminal"
megammrsync action:resync host:megammr.minima.global:9001 phrase:"YOUR 24 WORD SEED PHRASE" keyuses:2000
```
