...
Before we start, make sure you have a running Minima Node running. You can start your own signgle testnet node by following the instructions [here](/docs/development/testnet-single).
...
<AutoPlay src="/create-minima-app.mov" />
