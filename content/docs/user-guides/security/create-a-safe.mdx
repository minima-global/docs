...
You can then leave your node [unlocked](/docs/user-guides/security/lock-your-wallet) for daily use whilst keeping the majority of your holdings secured in a Safe with an alternative seed phrase.

## Create a new Safe

<img src="/img/app/vault.png" alt="test" width={100} height={100} />

1. If you haven't already, make sure you have [taken note of your main seed phrase](/docs/user-guides/security/lock-your-wallet), this can be found in the Security MiniDapp.
