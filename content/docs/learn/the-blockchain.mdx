...
description: Learn about the Minima Blockchain
tag: learn
---
...
<ThemeAwareSVG
  src="/img/blockchain/cascadingChain1Lm.svg"
  alt="The Blockchain"
  width={700}
  height={700}
/>
...
<Accordions>
<Accordion title="TxPoW tree node attributes">
...
**Note:** _this diagram illustrates a Cascade and Main chain with test parameters (only 2 blocks at each level). In practice there are a maximum of 128 blocks at each level._

Diagram: Cascading Chain and Main chain

<ThemeAwareSVG
  src="/img/blockchain/cascadingChain2Lm.svg"
  alt="The Blockchain"
  width={700}
  height={700}
/>
...
<Accordions>
<Accordion title="Cascading Chain">
...
- **[L<sub>Curr</sub> , L<sub>max</sub>]** _TxPowID **@** blocknumber_ **weight:** _weight of block at L<sub>Curr</sub> **@** timestamp_
...
_blocknumber_ **[0 , L<sub>max</sub>]** TxPowID **txns:** number of txns in the block **weight:** _block weight at L<sub>0</sub>/Total weight **@** timestamp_<br />
...
<ThemeAwareSVG
  src="/img/blockchain/blockChart1Lm.svg"
  alt="The Blockchain"
  width={700}
  height={700}
/>
...
<ThemeAwareSVG
  src="/img/blockchain/blockChart2Lm.svg"
  alt="The Blockchain"
  width={700}
  height={700}
/>
...
Each new block in the chain **B<sub>0</sub>(n)** _where n = latest block number_ contains a reference to the following set of blocks:
...
<Accordions>
<Accordion title="Super Parents">

Using the command `txpow txpowid:insertTxPoWID`, we can see the full details of the TxPoW including its Super Parents.

_Example showing 5 Super Parents of this block at levels 4, 11, 14, 16, 18 and the genesis block (cropped)._
...
**CW of Super Blocks on Level 0** = BW\*2<sup>0</sup> _i.e. Base weight\*1_<br />
**CW of Super Blocks on Level 1** = BW\*2<sup>1</sup> _i.e. Base weight\*2)_<br />
**CW of Super Blocks on Level 2** = BW\*2<sup>2</sup> _i.e. Base weight\*4_<br />
**CW of Super Blocks on Level 3** = BW\*2<sup>3</sup> _i.e. Base weight\*8_<br />
**CW of Super Blocks on Level 4** = BW\*2<sup>4</sup> _i.e. Base weight\*16_<br />
up to Level 31…<br />
