...
type={{
  password: {
    description:
      '(Optional) Set a password using letters and numbers only.',
    type: 'True',
  },
  file: {
    description:
...
type={{
  action: {
    description:
      '(Optional) action:mydetails, action:resync',
  },
  host: {
    description:
...
type={{
  ...
  resync: {
    description:
      'Perform the actual MegaMMR resync. (i.e. QuickSync)',
  },
}}
/>
...
type={{
  ...
  coinid: {
    description:
      '(Optional) The id of the coin to add as an input.',
  },
  coindata: {
    description:
...
type={{
  id: {
    description:
      '(Optional) The id of a single transaction to list.',
  }
}}
/>
