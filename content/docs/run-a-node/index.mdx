...
Download the [Minima JNLP](https://www.spartacusrex.com/javaws/minima.jnlpx) file and open / double-click it to install Minima as an application. A desktop shortcut will be created for you and you will be shown a security warning, select Run.
...
<Heading as="h3">Navigate to the directory where you saved the Minima jar</Heading>
...
Adding `-p2pnodes megammr.minima.global:9001` will automatically connect you to the peer-to-peer network.
...
/>
  ...
  <Card
    ...
    href="/docs/user-guides/security/lock-your-wallet"
/>
