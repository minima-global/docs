...
<sup>*</sup>A SQL database is not a prerequisite for running MEG, however it is recommended for the purpose of exporting and storing all/relevant transaction detail
