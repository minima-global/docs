...
Download the [Minima JNLP](https://www.spartacusrex.com/javaws/minima.jnlpx) file and open / double-click it to install Minima as an application, ensuring it always launches with Open Web Start. A desktop shortcut will be created for you and you will be shown a security warning, select Run.
