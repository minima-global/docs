...
Once up and running, you can participate by interacting in the community, and using the social MiniDapps like Chatter. Simply [set up your profile](/docs/user-guides/set-your-profile) and then [share your contact address](/docs/user-guides/maxima-contacts) with other users.
...
- currently available to purchase from [Uniswap](https://app.uniswap.org/#/swap?outputCurrency=0x0d8c1e8d8b591d8b4d4e7e1d2f4e4efb3f2f4f4f) or [MECX](https://mecx.io/).
