...
description: The terms of use for minidapps
tag: core
---
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.3.15 Section P: Dealing in Minima via Minima AG MiniDapps

1.4	These Terms govern your use of MiniDapps developed and provided by Minima AG and do not extend to independently developed applications on the Minima blockchain. All references to ‘dealing in Minima’ are limited to interactions conducted through Minima AG’s MiniDapps

1.5	By using MiniDapps and dealing in Minima, you confirm that you accept these Terms and that you agree to comply with them. If you do not agree to these Terms as they apply to any MiniDapps or your dealing in Minima, you must not use them or deal with Minima.

1.6	These Terms are presented during the installation of the Minima Android App, which includes MiniDapps pre-installed within the application. If you do not accept these Terms, you may only access MiniDapps to unlock funds previously locked via a MiniDapp and only in compliance with applicable laws.
...
**"ERC-20 Tokens"**: 	ERC-20 Tokens refer to Wrapped Minima, USDT, and ETH. While ETH itself does not strictly conform to the ERC-20 technical standard, it is treated as such for the purposes of these Terms;
...
**"Wrapped Minima"**: Wrapped Minima is exchangeable for Minima on a 1:1 basis under terms determined by Minima AG. Such exchanges are not guaranteed and are subject to operational discretion.
...
3.3	If you contact us, you are responsible for ensuring the contact details provided are accurate for the purposes of our response. Minima AG does not require continuous updates to contact details unless necessary for ongoing service resolution.
...
4.1 4.1	 As part of setting up your node, you will generate a seed phrase or set a custom phrase which can always be used to recover your funds. For additional security, you are able to encrypt your seed/custom phrase with a password or lock funds in a separate seed/custom phrase to that of your node. When setting custom passwords or phrases, we strongly encourage that you ensure they are highly secure and that you keep them safe, as you are responsible for any loss as a consequence of your seed phrase. You must keep these secure and not disclose them to anyone else. Any action or instruction by anyone using your password or seed phrase will be treated as if such action or instruction had been made by you, and we are not responsible for any loss as a result. If your password is compromised, you may use your seed phrase to rest your password, however there is no way to replace your seed phrase if it is compromised.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.1.3 you are not a citizen or resident of, or a legal entity in any country or territory which appears on the sanctions lists of the Office of Foreign Assets Control of the U.S. Department of Treasury (“OFAC”), United Nations Security Council (“UNSC”), His Majesty’s Treasury (“HMT”) or any other relevant sanctions list and you are not a named individual or entity on any relevant sanctions list, including but not limited to Specially Designated Nationals (SDN) lists maintained by the authorities listed above;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7.2.3 license, sell, rent, lease, transfer, assign, distribute, display, disclose, or otherwise commercially exploit Minima Intellectual Property, and this includes not doing so via any third party; and / or

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7.2.4 attempt to obtain, or assist third parties in obtaining, access to Minima Intellectual Property other than as expressly permitted by these Terms.

7.3	Developers are encouraged to build MiniDapps using Minima Intellectual Property, provided such development complies with applicable open-source licensing terms and does not misrepresent affiliation with or endorsement by Minima AG. 

7.4 All logos related to us and the Minima Intellectual Property are marks of Minima or our licensors. You may not copy, imitate, or use our trading names or logos without our prior written consent. All rights, title and interests in and to such is the exclusive property of us and our licensors.

7.5 Minima Intellectual Property may contain code, commonly referred to as open-source software, which is distributed under any of the many known variations of open source licence terms, including terms which allow the free distribution and modification of the relevant software’s source code and/or which require all distributors to make such source code freely available upon request, including any contributions or modifications made by such distributor (collectively, “Open Source Software”). To the extent that MiniDapps use or contain any Open Source Software, that element only is licensed to you under the relevant licence terms of the applicable third party licensor (“Open Source Licence Terms”), and you accept and agree to be bound by such Open Source Licence Terms.
...
8.3 Subject to clause A8.1, our total liability under these Terms shall be capped at the total amount of fees received by us from you in the year preceeding the breach.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;9.2.1 if we believe that there has been suspicious or unlawful conduct, including fraud;
...
11.1	Except Minima AG reserves the right to introduce or modify specific fees associated with the use of individual MiniDapps, such as token burns or other operational charges. These fees will be determined by the functionality and purpose of the respective MiniDapp and will be disclosed within the MiniDapp or accompanying documentation. Users remain responsible for all other associated costs, such as gas fees or third-party charges, incurred during the use of MiniDapps. 

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;11.1.1	Certain MiniDapps may rely on third-party services (e.g., exchanges) that impose their own fees, which are not controlled by Minima AG.

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;11.1.2	When using ERC-20 Tokens, additional fees may be incurred (e.g., prioritization costs), which are determined by the respective token protocols.
...
15.1 These Terms shall take effect from the date which you start using our MiniDapps or otherwise deal in Minima whichever is the earlier.
...
15.3 You may not assign, gran a lien, mortgage, transfer, charge or otherwise encumber any of your rights or obligations in a way which may impede your performance of your obligations under these Terms. We may assign the benefit of these Terms without restriction subject to compliance with Applicable Law.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.1.4 You shall notify us without undue delay of any unauthorized use and/or access of the Wallet MiniDapp. Upon receiving such notice, Minima AG may, at its sole discretion, take actions to mitigate risks, such as suspending access to the affected MiniDapp or providing guidance to the user. Minima AG disclaims any obligation to take specific actions in response to such notices.
...
3.2 You can create a Custom Token via the Wallet MiniDapp. No URL or external data entry is required for token creation. You must ensure that any Custom Token you create complies at all times with our Content Standards.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.1.4 shall notify us without undue delay of any unauthorized use and/or access of the ETH Wallet MiniDapp. Upon receiving such notice, Minima AG may, at its sole discretion, take actions to mitigate risks, such as suspending access to the affected MiniDapp or providing guidance to the user. Minima AG disclaims any obligation to take specific actions in response to such notices.
...
4.1 In addition to the general position set out in clause A9, , if the Future Cash MiniDapp ceases to be supported by us, this shall not affect any locked Cryptoassets which will continue to be available to claim by the destination wallet on the Release Date.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.1.1 you shall not use the Vestr MiniDapp in connection with Cryptoassets that the Minima Blockchain does not support (such as ERC-20 Tokens), and we are not responsible for any loss as a consequence of you not complying with this obligation; and

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.1.2 once Cryptoassets have been locked using the Vestr MiniDapp, you cannot unlock them or change the amount locked, nor can you alter the Vesting Dates or destination wallet for the transfer. As such before making any transfer using the Vestr MiniDapp you should make sure that you are certain you want to proceed.
...
4.1 In addition to the general position set out in clause A9, if we cease support for Vestr MiniDapp, users must manually claim their tokens via the Terminal MiniDapp or another compatible tool. Minima AG will provide guidance on constructing the required transaction to facilitate the claiming process.
...
1.2 We may from time to time alter the amount that can be staked, and the length of time for which Minima can be staked. We will also have the ability to alter the yield paid out by the Maximize MiniDapp at our discretion, and this includes the Maximize MiniDapp ceasing to pay any yield.
...
4.1 In addition to the general position set out in clause A9, if we cease supporting the Maximize MiniDapp, any existing locked stakes will remain unaffected. Users will be required to claim maturities via the Future Cash MiniDapp. If Future Cash support is also unavailable, users must use the Terminal MiniDapp or another compatible tool to claim their stakes. Detailed guidance will be provided to assist users in this process. No new stakes will be possible after support has ceased.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.1.1 you are responsible for ensuring that they are compatible with any device and MiniDapp they are sent to, and do not contain any Virus; and
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.3.2 you do not lose your password or seed phrase, as this could cause you to lose your account or Cryptoassets.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.1.2 the Script IDE MiniDapp: a tool for developers that allows you to build and test Minima smart contracts.
...
## SECTION P: DEALING IN MINIMA VIA MINIMA AG MINIDAPPS

#### P 1. INTRODUCTION

1.1 1.1	This section of the Terms applies exclusively to transactions involving Minima conducted through MiniDapps provided by Minima AG.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.1.4 you accept that Minima is created and you obtain Minima on an “as is” basis. Therefore, provided we act in good faith in accordance with these Terms, you accept that Minima AG does not currently provide Minima tokens. Minima tokens were created in the past, and their availability is determined by independent market participants;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.1.6 whilst Minima is intended to have the utility reflected in these Terms, we make no guarantees regarding the utility of Minima, which depends on applications developed by third parties. Minima AG may develop additional MiniDapps at its sole discretion but does not provide warranties for their functionality or availability;

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.1.7 Minima AG no longer offers Minima tokens. Any exchanges involving Minima tokens, such as for Wrapped Minima, are subject to separate agreements and terms of service; and
...
**DEALING IN CRYPTOASSETS INVOLVES A HIGH DEGREE OF RISK, AND, THEREFORE, SHOULD BE UNDERTAKEN ONLY IF YOU ARE CAPABLE OF EVALUATING THE RISKS INVOLVED AND ABLE TO BEAR THE RISK OF A COMPLETE LOSS OF ALL CAPITAL USED TO PARTICIPATE IN OWNERSHIP OR DEALINGS WITH CRYPTOASSETS. YOU SHOULD CAREFULLY CONSIDER THE RISKS DESCRIBED BELOW BEFORE DEALING IN CRYPTOASSETS. IT SHOULD BE NOTED THAT THE LIST OF RISK FACTORS DESCRIBED HEREUNDER IS NOT INTENDED TO BE EXHAUSTIVE AND DOES NOT NECESSARILY INCLUDE ALL THE RISKS TO WHICH YOU MAY BE EXPOSED WHEN DEALING IN CRYPTOASSETS.**
...
2. **The prices of Cryptoassets are extremely volatile**
...
The underlying protocols of Cryptoassets may be subject to substantial changes in their operating rules (called a “forks”), and these may alter the value or function of a Cryptoasset. A fork may result in multiple versions of a Cryptoasset, leading to volatility as one version becomes dominant over another, and one or both versions may lose value.
...
As noted elsewhere in these Terms, Minima is not sold as a security nor any other form of regulated investment product. Accordingly, there has not been any consideration as to whether Minima is a suitable or an appropriate thing for you to deal in. In addition to the risks applicable to all Cryptoassets as detailed above, you should be aware of the following risks in relation to Minima specifically:
